export default function HomeSection() {
  return (
    <section id="home-section" className="mt-16 px-4 scroll-mt-20 md:scroll-mt-24">
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center py-16">
        <h1 className="text-5xl md:text-6xl font-light text-blue-600 dark:text-blue-400 mb-4 animate-fade-in-up animate-delay-0">Spencer</h1>
